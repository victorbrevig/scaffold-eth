        ...
        <div style={{ width: "auto", margin: "auto", paddingBottom: 25, minHeight: 800 }}>
            ...
            <div className="site-card-wrapper">
                <Row gutter={16} className="rowHome">
                    <Col span={8}>
                        <Card bordered={false}>
                            <img src={BLOBBER} width="400" height="400" alt="BlobberAnim" />
                            <Title level={2} style={{ fontSize: 24, marginRight: 8 }}>What are Blobbers?</Title>
                    ...
                    <Col span={8}>
                        <Card>
                            <img src={COIN} width="400" height="400" alt="CoinAnim" />
                            <Title level={2} style={{ fontSize: 24, marginRight: 8 }}>The BLB token</Title>
                            <Paragraph style={{ fontSize: 16 }}>
