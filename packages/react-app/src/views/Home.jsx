                        ...
                        <div style={{ margin: 5, paddingRight: 30, paddingLeft: 30, paddingTop: 30, paddingBottom: 20 }} className="glassCard">
                            ...
                            <div style={{ textAlign: "left" }}>
                                ...
                                <Paragraph style={{ fontSize: 14 }}>
                                    ...
                                    Blobbers is a diverse NFT collection on the Arbitrum layer 2. Each blobber is stored fully on-chain. By storing each blobber as SVG code, the owner of a blobber can change it's apperance through upgrades.
                                </Paragraph>
                            </div>
