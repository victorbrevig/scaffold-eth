...
function Home({ readContracts, mainnetProvider, blockExplorer, totalSupply, DEBUG }) {
    ...
    return (
        <div style={{ width: "auto", margin: "auto", paddingBottom: 25, minHeight: 800 }}>
            ...
            <div className="glass">
                <img className="homedivsleftText" src={GIF} width="200" height="200" alt="Layer2Gif" />
                <div className="homedivsleft">
                    <Title className="homedivsleftText" level={2}>What are Blobbers?</Title>
                    <Paragraph className="homedivsleftText" textAlign="left">
            ...
            <div className="glass">
                <div className="homedivsright">
                    <Title className="homedivsrightText" level={2}>The BLB token</Title>
                    <Paragraph className="homedivsrightText" textAlign="left">
                ...
                <img className="homedivsrightText" src={COIN} width="250" height="250" alt="CoinAnim" />
            </div>
