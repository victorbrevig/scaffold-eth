...
module.exports = async ({ getNamedAccounts, deployments, getChainId }) => {
  ...
  const svgBackground = await ethers.getContract("SVGBackgroundGenerator", deployer);
  ...
  await deploy("YourCollectible", {
    ...
    args: [svgBody.address, svgHat.address, svgHat2.address, svgFullFace.address, svgMask.address, svgEye.address, svgMouth.address, svgMouth2.address, svgDetail.address, svgExtra.address, svgBackground.address, blobToken.address],
    log: true,
  });
