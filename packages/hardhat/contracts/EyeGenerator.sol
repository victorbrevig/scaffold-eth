        ...
        returns (string memory)
    {
        if (eye == 0) {
            ...
            return
                string(
                    abi.encodePacked(
                        '<g transform="translate(0 -10)"><defs><linearGradient id="linear-gradient-visor" x1="585" y1="402" x2="585" y2="490" gradientUnits="userSpaceOnUse"><stop offset="0" stop-color="#ff005c" /><stop offset="1" stop-color="#f9ff08" />',
                        '</linearGradient></defs><rect x="370.25" y="411" width="18.72" height="50" rx="9.18" fill="#3a3a3a" /><rect x="306" y="421" width="64.25" height="30" fill="#161616" /><path d="M727,384H441a52,52,0,0,0-52,52h0a52,52,0,0,0,52,52h79.37a42.17,42.17,0,0,0,29.8-12,47.95,47.95,0,0,1,67.66,0,42.17,42.17,0,0,0,29.8,12H727a52,52,0,0,0,52-52h0A52,52,0,0,0,727,384Z" fill="url(#linear-gradient-visor)" />',
                        '<path d="M668,389H593v68.77a52.64,52.64,0,0,1,28.36,14.65A37.41,37.41,0,0,0,647.63,483H668Z" fill="#fff" opacity="0.3" stroke="none"/></g>'
                    )
                );
        } else if (eye == 13) {
            // DEAD
            ...
            return
                string(
                    abi.encodePacked(
                        '<g fill="#',
                        color,
                        '" transform="translate(0 -5)"><path d="M386,415H282a17,17,0,0,0-17,17h0v17.5a8.51,8.51,0,0,0,8.5,8.5h0a8.51,8.51,0,0,0,8.5-8.5V432H386Z" />',
            ...
            return
                string(
                    abi.encodePacked(
                        '<g fill="#FF8585"><path d="M455,479l-1.34-1.11C424.82,454.46,417,446.19,417,432.77a20,20,0,0,1,20.12-20.11c9.16,0,14.3,5.14,17.88,9.16,3.58-4,8.72-9.16,17.88-9.16A20,20,0,0,1,493,432.77c0,13.42-7.82,21.69-36.66,45.16Z" />',
