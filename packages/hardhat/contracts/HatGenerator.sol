...
contract SVGHatGenerator {
  ...
  function render(uint8 hat, bytes3 color) external pure returns (string memory) {
    ...
    if(hat==0){ // planet
     ...
     return string(abi.encodePacked(
      '<g fill="#',color.toColor(),'"><path d="M339,120.5H740a0,0,0,0,1,0,0v0a56,56,0,0,1-56,56H395a56,56,0,0,1-56-56v0A0,0,0,0,1,339,120.5Z"',
      ...
      return string(abi.encodePacked(
      '<g fill="#',color.toColor(),'"><polyline points="479 159 504.37 177.48 479 177" fill="none" /><circle cx="540" cy="150" r="45" /><path d="M546,161a29,29,0,0,1-29,29" fill="none" />',
    ...
    return string(abi.encodePacked(
      '<g fill="#',color.toColor(),'" transform="translate(0 -30)">',
    ...
    return string(abi.encodePacked(
      '<g fill="#',color.toColor(),'" transform="translate(-3 10)">',
