...
contract SVGHatGenerator {
  ...
  function renderTokenHatById(uint8 hat, bytes3 color) external pure returns (string memory) {
    ...
    } else if(hat==14){ // sombreo
     return string(abi.encodePacked(
      '<g transform="translate(0 10)">',
      '<path d="M340,110.5H741a0,0,0,0,1,0,0v0a56,56,0,0,1-56,56H396a56,56,0,0,1-56-56v0A0,0,0,0,1,340,110.5Z" fill="#fff6b3" />',
      '<path d="M539.3,20.5h0a54.15,54.15,0,0,1,54.15,54.15V110.5a0,0,0,0,1,0,0H485.15a0,0,0,0,1,0,0V74.65A54.15,54.15,0,0,1,539.3,20.5Z" fill="#fff6b3" />',
      '<path d="M734.84,115.82h-1.13L711,134.67c-8.57,7.12-22.45,7.12-31,0l-22.69-18.85h-.9v.08l-22.59,18.77c-8.56,7.12-22.44,7.12-31,0l-22.69-18.85H579l-22.69,18.85c-8.56,7.12-22.44,7.12-31,0l-22.69-18.85h-.9v.08l-22.59,18.77c-8.56,7.12-22.44,7.12-31,0l-22.69-18.85h-1.14L401.6,134.67c-8.56,7.12-22.44,7.12-31,0l-22.69-18.85H347v.08" fill="none" stroke="#ff3636" stroke-width="15" />',
      '<path d="M734.84,126.35h-1.13L711,145.21c-8.57,7.11-22.45,7.11-31,0l-22.69-18.86h-.9v.09l-22.59,18.77c-8.56,7.11-22.44,7.11-31,0l-22.69-18.86H579l-22.69,18.86c-8.56,7.11-22.44,7.11-31,0l-22.69-18.86h-.9v.09l-22.59,18.77c-8.56,7.11-22.44,7.11-31,0l-22.69-18.86h-1.14L401.6,145.21c-8.56,7.11-22.44,7.11-31,0l-22.69-18.86H347v.09" fill="none" stroke="#54cc54" stroke-width="15" transform="translate(0 3)" />',
      '<path d="M340,110.5H741a0,0,0,0,1,0,0v0a56,56,0,0,1-56,56H396a56,56,0,0,1-56-56v0A0,0,0,0,1,340,110.5Z" fill="none" />',
      '<rect x="491.16" y="69.5" width="96.27" height="12" fill="#ff3636" stroke="none" />',
      '<rect x="491.16" y="80.5" width="96.27" height="12" fill="#54cc54" stroke="none" /></g>'
      ));
    } else if(hat==15){ // bun
      return string(abi.encodePacked(
      '<g fill="#',color.toColor(),'" >',
