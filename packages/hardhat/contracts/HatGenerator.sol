...
contract SVGHatGenerator {
  ...
  function render(uint8 hat, string memory color) external pure returns (string memory) {
    ...
    if(hat==0){ // planet
      ...
      return string(abi.encodePacked(
      '<g fill="#',color,'" transform="translate(20 -10)">',
    ...
    } else if(hat==14){ // sombrero
     return string(abi.encodePacked(
      '<g fill="#',color,'"><path d="M339,120.5H740a0,0,0,0,1,0,0v0a56,56,0,0,1-56,56H395a56,56,0,0,1-56-56v0A0,0,0,0,1,339,120.5Z"',
      ...
      return string(abi.encodePacked(
      '<g fill="#',color,'"><polyline points="479 159 504.37 177.48 479 177" fill="none" /><circle cx="540" cy="150" r="45" /><path d="M546,161a29,29,0,0,1-29,29" fill="none" />',
    ...
    } else if(hat==17){ // airmax 1s
    return string(abi.encodePacked(
      '<g fill="#',color,'" transform="translate(0 -30)">',
    ...
    } else if(hat==18){ //bucket hat
    return string(abi.encodePacked(
      '<g fill="#',color,'" transform="translate(-3 10)">',
