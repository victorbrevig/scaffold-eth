...
contract SVGDetailGenerator {
    ...
    function render(uint8 detail, string memory color)
        external
        pure
            ...
            return
                string(
                    abi.encodePacked(
                        '<g fill="#',
                        color,
                        '" stroke="none" style="filter:url(#glow)"><rect width="1080" height="1080" fill="#fff" transform="translate(0 -20)" opacity="0" /><rect x="699" y="896" width="87" height="61" rx="30" />',
