...
contract SVGFullFaceGenerator {
    ...
    function render(uint8 fullFace, string memory color) external pure returns (string memory) {
        ...
        return string(abi.encodePacked(
        '<g fill="#',color,'"><path d="M542.5,196.37h0c-131.72,0-238.5,106.78-238.5,238.5V609H781V434.87C781,303.15,674.22,196.37,542.5,196.37ZM496,483a63,63,0,0,1-24.57,5H446a42,42,0,0,1-42-42h0a42,42,0,0,1,42-42h25.43A63,63,0,0,1,496,409h0c16.68,7.06,40,20.34,47,37-7,16.67-30.32,29.95-47,37Zm131.5,47h-85a18.5,18.5,0,0,1,0-37h85a18.5,18.5,0,0,1,0,37ZM766,446a42,42,0,0,1-42,42H698.57A63,63,0,0,1,674,483c-16.68-7.06-40-20.34-47-37,7-16.67,30.32-29.95,47-37a63,63,0,0,1,24.57-5H724a42,42,0,0,1,42,42Z" />',
        ...
        return string(abi.encodePacked(
        '<g fill="#',color,'"><path d="M714,390H456a58,58,0,0,0-58,58h0a58,58,0,0,0,58,58h71v31a58,58,0,0,0,58,58h0a58,58,0,0,0,58-58V506h71a58,58,0,0,0,58-58h0A58,58,0,0,0,714,390Z" fill="#c9ae90" /><path d="M650.5,262a28.42,28.42,0,0,1-20-8.2,28.5,28.5,0,1,1,0-40.6,28.49,28.49,0,0,1,40,0A28.51,28.51,0,0,1,718,226.09a28.73,28.73,0,0,1,1,7.41" stroke="none" />',
