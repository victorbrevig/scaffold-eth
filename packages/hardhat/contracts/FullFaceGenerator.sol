            ...
            return
                string(
                    abi.encodePacked(
                        ...
                        '<line x1="766.75" y1="574" x2="766.75" y2="613" /><line x1="545" y1="511" x2="624" y2="511" /><circle cx="451.88" cy="437.25" r="26" fill="#fff" /><circle cx="711.88" cy="437.25" r="26" fill="#fff" /></g>'
                    )
                );
        } else if (fullFace == 2) {
            // ape
            return
                string(
                    abi.encodePacked(
                        ...
                        '<circle cx="583" cy="485" r="19" fill="#000" /><line x1="583.5" y1="487.5" x2="583.5" y2="543.5" /><circle cx="451.88" cy="437.25" r="26" fill="#fff" /><circle cx="711.88" cy="437.25" r="26" fill="#fff" /></g>'
                    )
                );
        } else if (fullFace == 3) {
            // pc
