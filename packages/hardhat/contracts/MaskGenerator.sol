        ...
        returns (string memory)
    {
        if (mask == 0) {
            ...
            return
                string(
                    abi.encodePacked(
                        '<g><path d="M542.5,194.63h0C408.57,194.63,300,303.2,300,437.13V458.2a19.17,19.17,0,0,0,19.17,19.17H374V500a75,75,0,0,0,75,75h74v37.45c0,12.47,9.7,23.09,22.16,23.54A23,23,0,0,0,569,613a23,23,0,0,0,46,0,23,23,0,0,0,46,0,23,23,0,0,0,23.84,23c12.46-.45,22.16-11.07,22.16-23.54V575h52.76A25.24,25.24,0,0,0,785,549.76V437.13C785,303.2,676.43,194.63,542.5,194.63Z" fill="#fff7d4" /><path d="M615,575h46a0,0,0,0,1,0,0v38a23,23,0,0,1-23,23h0a23,23,0,0,1-23-23V575a0,0,0,0,1,0,0Z" fill="#ccab23" />',
                        '<path d="M369,477.37h34.33A33.63,33.63,0,0,1,437,511h0" fill="none" /><path d="M569,575v38" /><path d="M615,575v38" /><path d="M661,575v38" /><path d="M604.84,453.25l-25.17,35.83A13.92,13.92,0,0,0,591.06,511h0a13.92,13.92,0,0,0,13.85-12.48,13.92,13.92,0,1,0,25.24-9.44L605,453.25Z" fill="#2d2d2d" /><circle cx="486" cy="420" r="44" fill="#2d2d2d" />',
                        '<circle cx="715" cy="420" r="44" fill="#2d2d2d" /><polyline points="305 387.91 317 405 335 383 352 383 363 390 373 376 389 376" fill="none" /><polyline points="710.21 261.97 706 275 693 275 683 291 689 299 691 310 681 313" fill="none" /></g>'
                    )
                );
        }
