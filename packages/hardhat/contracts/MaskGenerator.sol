        ...
        returns (string memory)
    {
        if (mask == 0) {
            ...
            return
                string(
                    abi.encodePacked(
                        '<g fill="#181818"><path d="M686.51,635.66l-46.37,17.18a164.58,164.58,0,0,1-114.28,0l-46.37-17.18A131,131,0,0,1,394,512.84V413.66A19.66,19.66,0,0,1,413.66,394H752.34A19.66,19.66,0,0,1,772,413.66v99.18A131,131,0,0,1,686.51,635.66Z" />',
